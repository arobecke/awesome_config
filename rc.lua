...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "Return", function () awful.util.spawn("google-chrome") end),
    awful.key({ modkey, "Shift"   }, "+", function () awful.util.spawn("caja") end),
    awful.key({ modkey, "Shift"   }, "s", function () awful.util.spawn("mate-control-center") end),
    awful.key({ modkey, "Shift"   }, "x", function () awful.util.spawn("xtrlock") end),
    ...
    awful.key({ modkey, "Shift"   }, "h", function () awful.util.spawn("nautilus") end),
